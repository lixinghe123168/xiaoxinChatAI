    ...
    with st.sidebar:
        ...
        with st.expander("📁 Skill 人设", expanded=True):
            ...
            new_skill_path = st.text_input(
                "Skill 目录路径",
                value=st.session_state.selected_skill_path,
                help="包含 config.yaml, persona.md, memories.md 的目录",
                key="skill_path_input"
            )
            
            if new_skill_path != st.session_state.selected_skill_path:
            ...
            with col_browse_left:
                if st.button("📂 选择文件夹", use_container_width=True, key="browse_folder_btn"):
                    try:
                        ...
                        if selected_path:
                            st.session_state.selected_skill_path = selected_path
                            st.rerun()
            ...
            with col_browse_right:
                display_path = st.session_state.selected_skill_path
